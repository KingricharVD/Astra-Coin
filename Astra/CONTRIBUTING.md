Contributing to Astra Core
============================

The Astra Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Astra Core project, and is not to be
confused with overall Astra Network Protocol consensus changes.

Whether a pull request is merged into Astra Core rests with the project merge
...
Patches that change Astra consensus rules are considerably more involved than
...
Where a patch set proposes to change the Astra consensus, it must have been
...
The project leader is the release manager for each Astra Core release.
