...
VERSION=
commit=false
url=https://github.com/Astracoin/Astra
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the Astra, gitian-builder, gitian.sigs, and Astra-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/Astracoin/Astra
...
then
	# Make output folder
	mkdir -p ./Astra-binaries/${VERSION}
