...
In order to support loading of multiple wallets in Astra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Astra.cpp.
...
Changes to Astra.cpp
----------------------
Astra.cpp is the entry point into Astra-qt, and as such, will require some minor modifications to provide hooks for
