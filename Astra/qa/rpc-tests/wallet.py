...
#   c) node1 mines 32 blocks, so now node 0 has 60001Astra, node 1 has 4250Astra, node2 has none.
#   d) node0 sends 601 Astra to node2, in two transactions (301 Astra, then 300 Astra).
