                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Astra Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAstra"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Astra Core"), this);
    aboutAction->setStatusTip(tr("Show information about Astra Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Astra Core help message to get a list with possible Astra command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Astra Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Astra network", "", count));
}
...
{
    QString strTitle = tr("Astra Core"); // default title
