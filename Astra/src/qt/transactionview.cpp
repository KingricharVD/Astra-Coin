                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Astra from zAstra"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAstra"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAstra));
