...
- Windows: %AppData%/Roaming/Astra
- Linux: ~/.Astra
- OSX: ~/Library/Application\ Support/Astra
...
- `Astra.conf`: special file which holds startup configuration. Instead of using startup arguments when calling Astrad, better approach is to put them into Astra.conf, line by line. 
...
- `wallet.dat`: the most important file. Stores private keys for your addresses. Losing this automatically means losing access to all of yours Astra coins.